...
class Ivole_Premium_Settings {
    ...
    protected function init_settings() {
        $this->settings = array(
            array(
                'title' => __( 'Customer Reviews (CR) Premium', IVOLE_TEXT_DOMAIN ),
                'type'  => 'title',
                'desc'  => __( '<p>Customer Reviews (CR) service works with two types of license keys: (1) premium and (2) free.</p><p>(1) You can unlock <b>all</b> features for managing customer reviews by purchasing a premium license key => <a href="https://www.cusrev.com/" target="_blank">Premium License Key</a></p><p>(2) New versions of the plugin will use the license key as a secret token for additional security when communicating with CR service for generating review forms, comment forms, and storing verified copies of reviews. If you do not need premium features but still would like to benefit from additional security, request a free license key (no premium features) => <a href="https://www.cusrev.com/register.html" target="_blank">Free License Key</a></p>', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                ...
                'type'  => 'title',
                'desc'  => __( 'Please enter your license key (free or premium) in the field below. The plugin will automatically determine type of your license key.', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                ...
                'type'  => 'title',
                'desc'  => __( 'Upload a logo of your shop. The logo will be added to email templates, review forms, and (if enabled) pages with verified reviews generated by the plugin. This feature requires the premium version.', IVOLE_TEXT_DOMAIN ),
                ...
                jQuery(function($) {
                    if ( jQuery('#ivole_license_status').length > 0 ) {
                        ...
                        jQuery.post(ajaxurl, data, function(response) {
                            ...
                            if ('<?php echo __( 'Active: Premium Version', IVOLE_TEXT_DOMAIN ); ?>' === response.message) {
