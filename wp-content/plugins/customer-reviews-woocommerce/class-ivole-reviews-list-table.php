					...
					if( 201 !== $ivole_reply[0] ) {
						...
						if( is_array( $order_product ) && $order_product[0] && $order_product[1]  ) {
							if ( isset( $_REQUEST['comment_status'] ) && $_REQUEST['comment_status'] === 'trash' ) {
								echo '<p class="ivole-reply-published-cr"><span class="ivole-reply-published-cr-span"><span class="dashicons dashicons-yes"></span> ' . __( 'A verified copy of this reply was published on <a href="https://www.cusrev.com/reviews/' . $this->ivole_verified_page . '/p/p-' . $order_product[1] . '/r-' . $order_product[0] . '" target="_blank">CR portal</a><span class="dashicons dashicons-external"></span>. If this reply is deleted, the verified copy will remain published. If this reply is edited, the verified copy will be updated. The page with verified copies of reviews and replies to reviews for your shop on CR portal can be completely hidden by disabling Trust Badges in the <a href="' . admin_url( 'admin.php?page=ivole-reviews-settings&tab=trust_badges' ) . '">plugin\'s settings</a>.</span>', IVOLE_TEXT_DOMAIN ) . '</p>';
							} else {
								echo '<p class="ivole-reply-published-cr"><span class="ivole-reply-published-cr-span"><span class="dashicons dashicons-yes"></span> ' . __( 'A verified copy of this reply was published on <a href="https://www.cusrev.com/reviews/' . $this->ivole_verified_page . '/p/p-' . $order_product[1] . '/r-' . $order_product[0] . '" target="_blank">CR portal</a><span class="dashicons dashicons-external"></span></span>', IVOLE_TEXT_DOMAIN ) . '</p>';
							}
						} else {
